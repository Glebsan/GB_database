...
create table user_likes(
	id serial primary key,
	who_liked bigint unsigned not null,
	was_liked bigint unsigned not null,
	is_like bool default 0,
	created_at datetime default current_timestamp,
	foreign key (who_liked) references users(id),
	foreign key (was_liked) references users(id)
);
